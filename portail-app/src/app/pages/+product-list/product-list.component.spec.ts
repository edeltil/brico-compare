...
describe('ProductListComponent', () => {
  ...
  beforeEach(fakeAsync(() => {
    TestBed.compileComponents().then(() => {
      ...
      return router.navigate(['/products']).then(() => {
        cmpDebugElement = fixture.debugElement.query(By.directive(ProductListComponent));
  ...
  it('can list products', () => {
    const page: ProductListComponent = cmpDebugElement.componentInstance;
    expect(page.products.length).toEqual(2);
    ...
    const productShowLink = getDOM().querySelector(el, 'li > a[href="/products/1"]');
    expect(productShowLink).toBeTruthy();
  ...
  it('list another page when page was changed', fakeAsync(() => {
    ...
    advance(fixture);
    cmpDebugElement = fixture.debugElement.query(By.directive(ProductListComponent));
    const cmp: ProductListComponent = cmpDebugElement.componentInstance;
